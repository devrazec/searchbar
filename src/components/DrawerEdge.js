...
import { Button, Drawer, DrawerHeader, DrawerItems, TabItem, Tabs, } from "flowbite-react";
...
const DrawerEdge = () => {
    ...
    return (
        <Drawer edge open={isOpen} onClose={handleClose} position="bottom" className="p-0 h-195">
            <DrawerHeader
                closeIcon={HiBars2}
                title="Advanded Filters"
                titleIcon={FaFilter}
